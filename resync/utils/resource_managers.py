...
def managed_file_operation(
    file_path: str, mode: str = "r", **kwargs
) -> Iterator[Any]:
    """
    ...
    if session_factory is None:
        ...
        try:
            ...
            try:
                ...
                session_factory = lambda: httpx.AsyncClient(timeout=DEFAULT_TIMEOUT, limits=DEFAULT_LIMITS, trust_env=True)
...
class ResourcePoolManager:
    ...
    def __init__(
        self, resource_manager: ResourceManager[T], max_size: int = 10
    ):
