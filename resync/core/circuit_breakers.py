        ...
        if new_state == "OPEN":
            _get_runtime_metrics().record_health_check(
                ...
                "opened",
                {
                    ...
                    "last_failure": str(breaker.last_failure)
...
def get_circuit_breaker_status() -> dict:
    ...
    return {
        "redis": {
            ...
            "last_failure": str(redis_breaker.last_failure)
            if redis_breaker.last_failure
            else None,
        ...
        "tws": {
            ...
            "last_failure": str(tws_breaker.last_failure)
            if tws_breaker.last_failure
            else None,
        ...
        "llm": {
            ...
            "last_failure": str(llm_breaker.last_failure)
            if llm_breaker.last_failure
            else None,
